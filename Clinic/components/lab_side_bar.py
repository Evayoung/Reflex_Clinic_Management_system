...
def nav_item(text: str, icon: str, message: int=None) -> rx.Component:
    return rx.box(
        ...
        color=rx.cond(
            lab_attendance_state.LabAttendanceState.current_view == text,
            "gray.200", 
            "#330099"
        ),
        background=rx.cond(
        ...
        on_click=lab_attendance_state.LabAttendanceState.change_lab_view(text),
        style=nav_style,
        _hover={
...
def sign_out_nav(text: str, icon: str) -> rx.Component:
    return rx.box(
        ...
        color="#330099",
        background="transparent",
        on_click=lab_attendance_state.LabAttendanceState.logout(),
        style=nav_style,
        _hover={
    ...
    return rx.box(
        rx.vstack(
            ...
            rx.vstack(
                ...
                nav_item("Medical Test", "test_tubes"),
