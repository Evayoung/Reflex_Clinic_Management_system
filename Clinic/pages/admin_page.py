...
from ..components import footer, admin_side_bar
from ..pages import admin_dashboard, admin_user, admin_student, admin_faculty, admin_depatment
        ...
        rx.vstack(
            rx.hstack(
                ...
                rx.box(
                    ...
                    rx.hstack(
                        rx.hstack(
                            rx.text(f"{admin_state.AdminState.navigator} /", font_size="14px"),
                            color="#333300",
                            align="center",
                            margin_right="2rem",
                            width="300px",
                    ...
                    rx.vstack(
                        rx.match(
                            admin_state.AdminState.current_view,
                            ("Dashboard", admin_dashboard.dashboard_page()),
                            ("User", admin_user.user_page()),
                            ("Student", admin_student.student_page()),
                            ("Faculty", admin_faculty.faculty_page()),
                            ("Department", admin_depatment.department_page()),
...
def confirm_logout():
    return rx.dialog.root(
        rx.dialog.content(
            ...
            rx.hstack(
                rx.button(
                    ...
                    color="white",
                    _hover={"bg": "#4a0309"},
                    on_click=admin_state.AdminState.confirm_logout,
                ),
                ...
                rx.button(
                    ...
                    color="white",
                    _hover={"bg": "#300261"},
                    on_click=admin_state.AdminState.cancel_logout,
                ),
                justify="center",
                align="center",
                spacing="3",
        ...
        open=admin_state.AdminState.is_logout,
    )
