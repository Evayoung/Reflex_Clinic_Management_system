...
from ..components import footer, doctor_side_bar
from ..pages import doctor_availability, doctor_dashboard, doctor_schedule, doctor_visit
from ..states import auth_state, doctor_visit_state, doctor_state
        ...
        rx.vstack(
            rx.hstack(
                ...
                rx.box(
                    ...
                    rx.hstack(
                        rx.hstack(
                            rx.text(f"{doctor_visit_state.DoctorVisitState.navigator} /", font_size="14px"),
                            color="#333300",
                            align="center",
                            margin_right="2rem",
                            width="300px",
                    ...
                    rx.vstack(
                        rx.match(
                            doctor_visit_state.DoctorVisitState.current_view,
                            ("Dashboard", doctor_dashboard.dashboard_page()),
                            ("Availability", doctor_availability.availability_page()),
                            ("Schedules", doctor_schedule.schedule_page()),
                            ("Visits", doctor_visit.visit_page()),
                            (doctor_dashboard.dashboard_page()),  # 
                        ),
...
def confirm_logout():
    return rx.dialog.root(
        rx.dialog.content(
            ...
            rx.hstack(
                rx.button(
                    ...
                    color="white",
                    _hover={"bg": "#4a0309"},
                    on_click=doctor_state.DoctorState.confirm_logout,
                ),
                ...
                rx.button(
                    ...
                    color="white",
                    _hover={"bg": "#300261"},
                    on_click=doctor_state.DoctorState.cancel_logout,
                ),
                justify="center",
                align="center",
                spacing="3",
        ...
        open=doctor_state.DoctorState.is_logout,
    )